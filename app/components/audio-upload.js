  ...
  didInsertElement: function () {
    ...
    var resetButton = function () {
      this.$('.wy-form-upload-content button')
        ...
        .addClass('icon-music btn-neutral')
        .text(' Drag or select audio file');
    }.bind(this);
    ...
    var $uploadButton = this.$('.wy-form-upload-content button').upload({
      ...
      dropzonewindowenter: function () {
        $(this)
          .removeClass('icon-music icon-desktop btn-neutral')
      ...
      mouseenter: function () {
        $(this)
          .removeClass('icon-music icon-arrow-down btn-success')
